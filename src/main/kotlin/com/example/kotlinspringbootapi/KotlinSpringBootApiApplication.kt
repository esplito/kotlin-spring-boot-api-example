...
class MessageService(val db: MessageRepository) {
    ...
    /*
     🚨 The .query() function that is used to fetch the message by its id is a Kotlin extension function provided by the Spring Framework. It requires an additional import `import org.springframework.jdbc.core.query`.
    ...
    fun save(message: Message) {
        /*
        ℹ️ Comment regarding implementation before switching to CrudRepository ℹ️
        ...
        */
        // TODO: Add error handling for when id provided does not exist (currently generates a 500 internal server error)
        db.save(message) // works as both CREATE & UPDATE as comment above states
    }

    /*
    Note from the tutorial ℹ️:
